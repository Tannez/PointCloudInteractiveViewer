...
namespace BAPointCloudRenderer.ObjectCreation
{
    ...
    public abstract class MeshConfiguration : MonoBehaviour
    {
        ...
        /// <param name="classData">Classification (added parameter to scripts)</param>
        /// <param name="intensityData">Intensity (added parameter to scripts)</param>
        /// <param name="boundingBox">Bounding Box</param>
        /// <returns></returns>
        public abstract GameObject CreateGameObject(string name, Vector3[] vertexData, Color[] colorData, int[] classData, float[] intensityData, BoundingBox boundingBox, Transform parent);
