...
namespace BAPointCloudRenderer.CloudController
{
    ...
    public class Preview : MonoBehaviour
    {
        ...
        public void UpdatePreview()
        {
            ...
            PointCloudLoader[] allLoaders = FindObjectsByType<PointCloudLoader>(FindObjectsSortMode.InstanceID);
        ...
        {
            PreviewObject[] previewObjects = FindObjectsByType<PreviewObject>(FindObjectsSortMode.InstanceID);
