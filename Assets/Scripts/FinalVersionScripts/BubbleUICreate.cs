...
namespace LLMPCCompanionBubble
{
    ...
    class BubbleUICreate
    {
        ...
        public static PointCloudControls pointCloudControls
        {
            get
            {
                ...
                _pointCloudControls = UnityEngine.Object.FindFirstObjectByType<PointCloudControls>();
        ...
        public BubbleUICreate(Transform parent, BubbleUI ui, string name, string message)
        {
            bubbleUI = ui;
        ...
        protected GameObject CreateImageObject(Transform parent, string name)
        {
            ...
            imageObject.gameObject.layer = 5;
    ...
    class LLMInputBubble : BubbleUICreate
    {
        protected GameObject inputFieldObject;
        protected InputField inputField;
        protected GameObject placeholderObject;

        public LLMInputBubble(Transform parent, BubbleUI ui, string name, string message, int lineHeight = 4) :
